 ...
 * MAAP General
 *******************************/
export const MAAP_PROFILE_TOKENS_URL = 'https://console.maap-project.org/profile/tokens';
export const MAAP_PROFILE_TOKENS_URL_UAT = 'https://console.uat.maap-project.org/profile/tokens';
